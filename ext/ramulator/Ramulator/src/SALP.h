...
public:
    ...
    SALP(const Config& configs, const string& type_str);
    ...
    { 
        ACT, SASEL, PRE, PREA, // precharge bank/bank/rank(SALP-1), subarray/bank/rank(SALP-2, MASA)
    ...
    Command translate[int(Request::Type::MAX)] = {
        ...
        Command::REF, Command::PDE, Command::SRE, Command::SRE, Command::RD
    };
    ...
    struct OrgEntry {
        ...
        //{8<<10,  4, {0, 0, 16, 0, 0, 1<<12}}, {8<<10,  8, {0, 0, 16, 0, 0, 1<<11}}, {8<<10, 16, {0, 0, 16, 0, 0, 1<<10}},
        {4<<11, 16, {0, 0, 8, 1, 1<<16, 1<<10}},
    }, org_entry;
    ...
    enum class Speed : int
    {
        ...
        //SALP_2133L, SALP_2133M, SALP_3200,
        SALP_3200CR,
        MAX
    };
   ...
   //     Refresh_2X,
     //   Refresh_4X,
        MAX
    } refresh_mode = RefreshMode::Refresh_1X; // Hasan: according to the datasheet, 1X refresh should be 32 ms refresh for LPDDR4
    ...
    struct SpeedEntry {
        ...
        int nCL, nRCD, nRPSSA, nRPDSA, nRPab, nRP, nCWL; // nRP for pre2act same sa, nPA for pre2act diff sa (1 cycle)
        int nRAS, nRC;
        ...
        //{3200, 1600, 0.625, prefetch_size/2/*DDR*/, 4, 2, 22, 22, 22, 1, 16, 56, 78, 12, 12, 24, 11, 32, 0, 0, 0, 8320, 6, 7, 26, 7, 0, 512, 1}
         {3200, 400.0*4, 2.5/4, prefetch_size/2, 8, 2, 3/*nDQSCK*/, 28/*nCL*/, 29/*nRCD*/, 
            29, 5 /*nRPDSA*/, 34, 29/*nRP*/, 14/*nCWL*/, 67, 96, 12, 16, 29/*nWR*/, 4, 16, 64, 0, 0, 0, 0/*nCKE*/, 12, 24, 0, 10 /*nSCD*/} // Hasan edited
    }, speed_entry;
