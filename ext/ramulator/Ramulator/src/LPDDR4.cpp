...
map<string, enum LPDDR4::Org> LPDDR4::org_map = {
    ...
    {"LPDDR4_16Gb_x16", LPDDR4::Org::LPDDR4_16Gb_x16},
    {"LPDDR4_32Gb_x16", LPDDR4::Org::LPDDR4_32Gb_x16},
    {"LPDDR4_64Gb_x16", LPDDR4::Org::LPDDR4_64Gb_x16},
};
...
LPDDR4::LPDDR4(const Config& configs) : LPDDR4(org_map[configs["org"]], speed_map[configs["speed"]]){
...
void LPDDR4::set_subarray_number(int sa) {}
...
void LPDDR4::init_speed()
{
    ...
    switch (org_entry.size >> 10){
        ...
        default: assert(false && "Unsupported LPDDR4 organization");
    }
