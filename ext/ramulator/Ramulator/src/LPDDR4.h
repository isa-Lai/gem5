...
public:
    ...
    Command translate[int(Request::Type::MAX)] = {
        ...
        Command::REF, Command::PDE, Command::SREF, Command::SREF, Command::RD
    };
    ...
    enum class Org : int
    {
        ...
        LPDDR4_32Gb_x16, // tRFC TBD
        LPDDR4_64Gb_x16, // tRFC TBD
        MAX
    };
    ...
    struct OrgEntry {
        ...
        {4<<11, 16, {0, 0, 8, 1<<16, 1<<10}},
        {4<<12, 16, {0, 0, 8, 1<<17, 1<<10}},
        {4<<13, 16, {0, 0, 8, 1<<18, 1<<10}},
    }, org_entry;
    ...
    struct SpeedEntry {
        ...
        int nCL, nRCD, nRPpb, nRPab, nRP, nCWL; // Hasan: added nRP as an alias to nRPpb for reusing then changes for DDR4 on Controller.h
        int nRAS, nRC;
        int nRTP, nWTR, nWR;
        int nPPD, nRRD, nFAW;
        ...
        {3200, 400.0*4, 2.5/4, prefetch_size/2, 8, 2, 3/*nDQSCK*/, 28/*nCL*/, 29/*nRCD*/, 
            29, 34, 29/*nRP*/, 14/*nCWL*/, 67, 96, 12, 16, 29/*nWR*/, 4, 16, 64, 0, 0, 0, 0/*nCKE*/, 12, 24, 0} // Hasan edited
    }, speed_entry;
