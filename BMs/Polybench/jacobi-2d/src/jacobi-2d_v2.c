...
//    m5_checkpoint(0,0);
  int t, i, j;
   ...
   /********************** Fill descriptor data structure for loop 1 ***********************/
    ...
    MISA_DirStreamDesc_t  arrB_metaData      = { LOOP1_ID , 0 , RESERVED , (uint64_t)&B[0][0],
    ...
    printf("&A[_PB_N-1][_PB_N-1]=%p , A Descriptor = %#llx %llx  \n",&A[_PB_N-1][_PB_N-1],*(arrADesc),*(arrADesc+1));
    printf("&B[_PB_N-1][_PB_N-1]=%p , B Descriptor = %#llx %llx  \n",&B[_PB_N-1][_PB_N-1],*(arrBDesc),*(arrBDesc+1));
