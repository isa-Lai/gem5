...
enum ParentloopsIDs   { NO_PARENT = 0,PARENT_IS_LOOP1 };
enum loopsIDs         { LOOP1 = 1,LOOP2 ,LOOP3 };
enum descIDs          { LOOP1_ID = 0 ,LOOP2_ID = 1,LOOP3_ID = 2, LOOP4_ID = 3 , ArrA_ID , ArrB_ID };
